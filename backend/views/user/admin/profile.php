<?php
    ...
    $this->title = Yii::$app->params['system_name'] . ' | Administrator Profile';
...
<div class="page animsition">
    <div class="page-header  padding-bottom-0">
        ...
        <div class="page-header-actions">
            ...
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/user/update-administrator/<?php echo !empty($user['username']) ? $user['username'] : ''; ?>" type="button" class="btn btn-sm btn-icon btn-primary btn-round" data-toggle="tooltip" data-original-title="Edit" data-placement="left">
