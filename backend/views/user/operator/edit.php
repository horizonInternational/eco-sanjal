...
$this->title = Yii::$app->params['system_name'] . ' | Update Operator';
?>
<div class="page animsition">
    <form action="<?php echo Yii::$app->request->baseUrl;?>/user/edit-operator" name="editOperator" data-tablename="users" data-action="update-operator" method="post" class="form-horizontal operator users">
