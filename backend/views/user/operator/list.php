<?php
    ...
    if (Yii::$app->session[Yii::$app->params['user-session']]->role != Yii::$app->params['user_role']['admin']) {
        return Yii::$app->response->redirect(Url::to(Yii::$app->request->baseUrl));
        // Misc::forceLogout();
    }
    ...
    $this->title = Yii::$app->params['system_name'] . ' | Operators';
?>
<div class="page animsition">
    <div class="page-header  padding-bottom-0">
        ...
        <div class="page-header-actions">
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/user/create-operator" class="btn btn-sm btn-icon btn-primary btn-round" data-toggle="tooltip" data-original-title="Add New Operator" data-placement="bottom">
                                ...
                                <table class="table table-hover dataTable table-striped width-full with-export dtr-inline " id="user-table">
                                    ...
                                    <?php if ($users != null) : $i = 0; ?>
                                        <?php foreach ($users as $user) : ?>
                                            <tr data-id="<?php echo $user['id']; ?>" data-role="operator">
                                                <td><?php echo ++$i; ?></td>
                                                ...
                                                <td>
                                                    <div class="table-row-controls">
                                                        <!-- <a href="--><?php //echo Yii::$app->request->baseUrl . '/user/view-operator/' . $user['username'];?><!--" class="block"> -->
                                                        <!-- <i class="icon ti-user"></i>-->
                                                        <!-- </a>-->
                                                        <a href="<?php echo Yii::$app->request->baseUrl . '/user/update-operator/' . $user['username']; ?>" class="edit-operator block">
