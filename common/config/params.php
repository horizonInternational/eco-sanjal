<?php
    ...
    $relative_path = '/common/assets/';

    return [
        'system_name'                   => 'Eco Sanjal',
        'title'                         => 'Eco Sanjal',
        'adminEmail'                    => '',
        'supportEmail'                  => '',
        'user.passwordResetTokenExpire' => 3600,
        'user-session'                  => 'saA32f3q4aEFVaHT23Q3e3a4WEd5',
        'cart-session'                  => 'nI^j5&n7H%a#',
        'cart'                          => [],
        'currency'                      => '$',

        'upload_path'             => array(
            'image' => $real_path . 'uploads/images' . DIRECTORY_SEPARATOR,
            'documents' => $real_path . 'uploads/documents' . DIRECTORY_SEPARATOR,
        ),
        'image_path'              => array(
            'relative' => $relative_path,
            'image'    => $relative_path . 'images/',
            'uploads'  => $relative_path . 'uploads/images/',
            'no-image' => $relative_path . 'images/no-image.png',
        ),
        'document_path'           => array(
            'relative' => $relative_path,
            'document' => $relative_path . 'uploads/documents/',
        ),
        'role_user'               => array(
            'AsdWQwsdWa' => 'superadmin',
            'UBGcWtaIva' => 'admin',
            'QbCMajSNzb' => 'vendor',
            'KgH8Ejh8dD' => 'agent',
            'ScAajSsNWe' => 'user',
